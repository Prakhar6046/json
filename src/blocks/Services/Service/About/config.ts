      ...
      fields: [
        {
          ...
          label: 'Step Title',
          required: true,
          admin: { description: 'Title for this step/card' },
        },
        {
          name: 'description',
          type: 'textarea',
          ...
          required: true,
          admin: { description: 'Description text for this step/card' },
        },
        {
          name: 'icon-unhovered',
          type: 'upload',
          ...
          required: true,
          admin: { description: 'Icon image for this step/card (Unhovered)' },
        },
        {
          name: 'icon-hovered',
          type: 'upload',
          ...
          required: true,
          admin: { description: 'Icon image for this step/card (Hovered)' },
        },
        {
          name: '_order',
          type: 'number',
