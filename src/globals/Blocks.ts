...
import { gdprIntro } from '@/blocks/Services/Blocks/Template/GdprIntro/config'
import { gdprPrinciples } from '@/blocks/Services/Blocks/Template/GdprPriciples/config'
import { WhoNeedsToComply } from '@/blocks/Services/Blocks/Template/california-consumer-privacy-act-ccpa-compliance/WhoNeedsToComply/config'
import FedRampAdvisoryConfig from '@/blocks/Services/Blocks/Template/FedRamp/FedRampAdvisory/config'
import FedrampAdvisoryConfigV2 from '@/blocks/Services/Blocks/Template/FedRamp/FedRampAdvisoryV2/config'
import AuthorizationMonitoringSectionConfig from '@/blocks/Services/Blocks/Template/FedRamp/FedRampAuthorization/config'
import FedRampHeaderConfig from '@/blocks/Services/Blocks/Template/FedRamp/FedRampHeading/config'
import ReadinessAssessmentSectionConfig from '@/blocks/Services/Blocks/Template/FedRamp/ReadinessAssessment/config'
import WhyChooseWCGSectionConfig from '@/blocks/Services/Blocks/Template/FedRamp/WhyChooseWCG/config'
import FISMAComplianceSectionConfig from '@/blocks/Services/Blocks/Template/Fisma/FismaComplianceHeader/config'
import FISMABecomeSectionConfig from '@/blocks/Services/Blocks/Template/Fisma/HowToBecome/config'
...
export const ServiceBlocks: Block[] = [
  ...
  gdprPrinciples,
  WhoNeedsToComply,
  FedRampAdvisoryConfig,
  FedrampAdvisoryConfigV2,
  AuthorizationMonitoringSectionConfig,
  FedRampHeaderConfig,
  ReadinessAssessmentSectionConfig,
  WhyChooseWCGSectionConfig,
